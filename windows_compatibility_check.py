...
def generate_compatibility_report(all_issues: List[Tuple[str, Any]]):
    """生成兼容性报告"""
    print("\n" + "="*80)
    ...
    if not all_issues:
        ...
        # 按类型分组问题
        issue_groups = {}
        for issue_type, details in all_issues:
        ...
        if any('path' in str(issue) for issue_type, issue in all_issues):
            print("   📁 路径问题:")
