...
if not DEPENDENCIES_AVAILABLE:
    import pytest
    pytest.skip(
        f"Skipping image similarity tests due to missing dependencies: {_import_error}",
...
class TestImageSimilarity(unittest.TestCase):
    ...
    def test_hash_similarity_different(self):
        ...
        self.assertLessEqual(similarity, 1.0)  # 不同图片相似度应该不超过1.0
    ...
    def test_fast_similarity_different(self):
        ...
        self.assertLess(similarity, 0.95)  # 不同图片应该比相同图片相似度低
