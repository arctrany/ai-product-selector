...
系统应能够智能识别页面中的跟卖商品区域，支持多种页面布局和动态内容加载。
...
系统应准确识别和解析跟卖商品的数量信息，支持多种数量表示格式。
...
### Requirement: 配置化检测策略
系统应支持灵活的配置化检测策略，适应不同的业务需求和页面变化。
